<template>
  <div id="app" class="container-fluid">
    ...
    <div class="mb-4">
      ...
      <b-button variant="secondary" @click="componenteSelecionado = 'AlertaAdvertencia'">Alerta advertencia</b-button>
    </div>
    ...
    <div class="divisor mb-3">
      <b-button @click="addAluno" class="mr-4">Add</b-button>
    <!-- <b-button >Remover</b-button> -->
    </div>
    <transition-group name="slide" tag="div">
      <b-list-group v-for="(aluno, index) in alunos" :key="aluno">
        <b-list-group-item @click="removeAluno(index)">{{ aluno  }}</b-list-group-item>
      </b-list-group>
    </transition-group>
